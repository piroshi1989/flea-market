...
<div class= index__select>
    <a href="/mypage/exhibited" class="color__select">出品した商品</a>
...
<div class="item__wrap">
    @foreach($exhibitedItems as $exhibitedItem)
    <div class="item__content">
        <div class="item__image">
            <a href="{{ asset('/item/' . $exhibitedItem['id']) }}">
                <img src="{{asset($exhibitedItem['image_url'])}}">
            </a>
        </div>
        <div class="item__info">
            <p class="item__price">\ {{ $exhibitedItem['price'] }}</p>
        </div>
    </div>
    @endforeach
</div>
